  ...
  const ctx = useMemo(() => {
    return {
      ...
      async updateProfile(patch) {
        ...
        if (patch?.phone !== undefined) payload.phone = patch.phone ? String(patch.phone).trim() : null
        if (!payload.name && !payload.email && payload.phone === undefined) throw new Error('Nothing to update')
